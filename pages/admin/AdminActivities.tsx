      ...
      <div className="flex flex-col items-center justify-center h-full py-20">
        <div className="relative">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <Calendar size={36} className="text-kpf-red animate-pulse" />
          </div>
        </div>
  ...
  return (
    <div className="space-y-6 p-6">
      ...
      <div className="flex items-center justify-between bg-gradient-to-r from-kpf-teal to-kpf-teal rounded-2xl p-6 shadow-lg text-white">
        ...
        >
          <Plus size={24} />
          <span>{t("admin_activities_new")}</span>
        </button>
      </div>
            ...
            return (
              ...
              >
                ...
                <div className="col-span-1 flex justify-center">
                  <button
                    onClick={() => toggleActive(activity.id, activity.isActive)}
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="text-xs text-slate-500 mt-1">
                    {language === "tr"
                      ? "Seçilen tarih otomatik olarak formatlı şekilde gösterilecektir"
                      : "Das ausgewählte Datum wird automatisch formatiert angezeigt"}
                  </p>
                </div>
                <div>
                  <label className="block text-sm font-semibold text-slate-700 mb-2">
